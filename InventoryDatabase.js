...
//	readInput.readFile('Input.txt', (err, data) => {
//		if (err)
//			throw err;
//		var itemInput = data.toString());
//		var itemInputs = itemInput.val().split('\n');
//	});
...
//	for(var i = 0; i < itemInputs.length; i++) {
		var TableInsert = "INSERT INTO storeDatabase (itemNumber, name, price, stock, intStock, imgSrc) VALUES ?"; //itemInputs[i];
		var values = [
